...
Once the images are annotated, we can use the LabelMe2TrackTacularFormat.py script to output annotations of the images suitable for TrackTacular - which is similar to the WildTrack dataset. 
